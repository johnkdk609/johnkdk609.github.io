...
* Level: 치상위 노드를 Level 0으로 하였을 때, 하위 Branch로 연결된 노드의 깊이를 나타냄
...
또, Child Node를 두 개 가지고 있는 경우도 두 가지 경우로 나눠서 접근해야 한다.
...
searche failed, delete failed가 단 하나도 나타나지 않는다. 잘 작동하는 것이다.
...
![https://www.fun-coding.org/00_Images/worstcase_bst.png](https://user-images.githubusercontent.com/88493727/229437327-02cbf642-b0fc-4051-82f8-04bc30f388db.png "이진 탐색 트리 최악의 경우")
