...
<img src="/assets/img/captures/ca9663ac-4334-48a3-aa9f-fd793c4f029b.png" width="300px" />
...
<img src="/assets/img/captures/64041dc7-fda5-4b89-8e5f-aba531238e0f.png" width="650px" />

데이터를 보낸다고 했을 때 주소도 있어야 하고, 에러 체크도 있어야 한다. 전송 계층에서는 오류 체크를 할 수 있고, 인터넷 계층은 목적지로 가게끔 하는 주소 역할을 한다.

데이터를 보낸다고 했을 때, <u>애플리케이션 계층 → 전송 계층 → 인터넷 계층 → 링크 계층 순서로 통해서 데이터가 가게 된다.</u>

<br>

그리고 이 <b>네 개 계층은 서로 독립적</b>이다. http에는 http1, http2, http3 가 있다. 이런 식으로 버전이 바뀌었다고 해서 브라우저를 다시 설치하는가? 그렇지 않다. 이러한 계층들은 서로 독립적이다. 서로 영향을 받지 않는 것이다.
...
TCP/IP 4계층과 OSI 7계층의 차이점에 대해 설명할 수 있어야 한다.